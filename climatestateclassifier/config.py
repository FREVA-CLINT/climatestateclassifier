...
def set_common_args():
    ...
    arg_parser.add_argument('--data-files-train', type=str_list, default='',
                            help="File containing the training data. Three columns: col0 - filepaths, col1 - train/val, col2 - y")
    arg_parser.add_argument('--data-files-val', type=str_list, default='',
                            help="File containing the training data. Three columns: col0 - filepaths, col1 - train/val, col2 - y")
    arg_parser.add_argument('--target-name', type=str,
