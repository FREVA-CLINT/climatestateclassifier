...
def set_common_args():
    ...
    arg_parser.add_argument('--lats', type=int, default=None, help="Stop rotations after specified number")
    arg_parser.add_argument('--lons', type=int, default=None, help="Stop rotations after specified number")
